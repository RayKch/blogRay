		...
		<div class="container">
			<div class="row">
				...
				<div class="area-wrapper">
					...
					<div class="area-right form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control col-sm-10" id="title" placeholder="카테고리 제목을 입력하세요" alt="카테고리명">
							</div>
						</div>
						<div class="form-group">
							<label for="description" class="col-sm-2 text-right">설명</label>
							<div class="col-sm-10">
								<textarea class="form-control" id="description" placeholder="카테고리 설명을 입력하세요" alt="카테고리설명"></textarea>
							</div>
						</div>
