		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
					<form action="/board/insert/proc" method="post" accept-charset="utf-8" onsubmit="return BoardUtil.submitProc(this) && IEAcceptCharset(this)" target="zeroframe">
...
<script type="text/javascript">
	...
	var BoardUtil = {
		...
		, IEAcceptCharset:function(obj) {
			if (obj.canHaveHTML) { // detect IE
				document.charset = obj.acceptCharset;
			}
			return true;
		}
	}
