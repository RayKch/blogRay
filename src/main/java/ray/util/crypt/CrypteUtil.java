...
public class CrypteUtil {
	 ...
	 */
	public String encrypt(String data, byte[] key, int keySize, String charset)
	 ...
	 * @throws java.security.InvalidKeyException If the Masterkey is not valid
	 */
	public String decrypt(String data, byte[] key, int keySize, String charset)
	throws UnsupportedEncodingException, InvalidKeyException {
